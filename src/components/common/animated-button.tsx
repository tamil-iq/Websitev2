...
export function AnimatedButton({ children, onClick }: AnimatedButtonProps) {
  ...
  <div className="relative rounded-lg">
    ...
    <div className="relative z-20 p-3">
      <button 
        onClick={onClick} 
        className="lg:px-9 lg:py-4 px-9 py-3 text-sm lg:text-[15px] bg-[#056EE7]/20 border border-[#056EE7]/40 lg:font-semibold font-normal
         tracking-wider uppercase text-foreground rounded-md cursor-pointer transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 overflow-hidden"
      >
        {children}
      </button>
    </div>
