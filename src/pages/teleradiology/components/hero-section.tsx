        ...
        >
            ...
            <div className="grid xl:grid-cols-3 lg:grid-cols-4 md:grid-rows-4 relative w-full h-full z-10 ">
                ...
                >
                   ...
                   >
                    <label className="text-gradient md:text-[50px] text-3xl">Every Report. Expert Eyes.</label>
                   </motion.h1>
                   <motion.p 
                ...
                >
                    ...
                    Subspecialty radiologists who take the time to get it right. Because accurate diagnosis is where better outcomes begin                    </p>
                </motion.div>
